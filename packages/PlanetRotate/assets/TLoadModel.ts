...
export const gltFramePromise = new Promise<Group>((resolve, reject) => {
  gltfloader
    .loadAsync("../packages/PlanetRotate/glbmodule/4.glb")
...
export const framePromise = new Promise<Mesh>((resolve, reject) => {
  DefaultLoaderManager.addEventListener("loaded", (event) => {
    ...
    frame.material = new MeshStandardMaterial({
      map: scourceMap[
        "../packages/PlanetRotate/glbmodule/WoodFloor024_1K_Color.jpg"
      ],
      roughnessMap:
        scourceMap[
          "../packages/PlanetRotate/glbmodule/WoodFloor024_1K_Roughness.jpg"
        ],
      bumpMap:
        scourceMap[
          "../packages/PlanetRotate/glbmodule/WoodFloor024_1K_Displacement.jpg"
        ],
    });
